...
Truncated to 63 chars because Kubernetes DNS naming spec.
*/}}
...
{{/*
Common labels — applied to every resource for consistency and tooling.
*/}}
...
{{/*
Selector labels — used by Service and Deployment to identify Pods.
*/}}
